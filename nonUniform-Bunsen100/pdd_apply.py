...
# initialize
st = SpFluid(Domain([params['res'], params['res']]), buoyancy_factor=0, batch_size=params['sbatch'], amp=params['amp'], eq=params['er'])
...
for b in range(params['sbatch']):
    ...
    if b == 0:
        ...
        rd_array = np.tile(r1_array, (1, 100, 1, 1))
    else:
        ...
        r0_array = r0_array.reshape((1, params['res'], params['res'], 1))
        r1_array = r0_array[:,0:1,:,:]
        r1_array = np.tile(r1_array, (1,100,1,1))
